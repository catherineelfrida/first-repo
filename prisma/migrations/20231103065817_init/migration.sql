...
-- AddForeignKey
ALTER TABLE "transaction" ADD CONSTRAINT "transaction_destacc_fkey" FOREIGN KEY ("destacc") REFERENCES "account"("accnumber") ON DELETE RESTRICT ON UPDATE CASCADE;
